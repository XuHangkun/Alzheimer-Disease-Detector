...
--train_info_path ../model/train_AAL_lr1.e-3_dp0.2_info.csv \
--valid_info_path ../model/valid_AAL_lr1.e-3_dp0.2_info.csv \
--model_path ../model/baseline/baseline_AAL_lr1.e-3_dp0.2_epoch%d.pth \
--dropout 0.2
