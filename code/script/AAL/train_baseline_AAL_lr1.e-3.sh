...
--train_info_path ../model/train_AAL_lr1.e-3_info.csv \
--valid_info_path ../model/valid_AAL_lr1.e-3_info.csv \
--model_path ../model/baseline/baseline_AAL_lr1.e-3_epoch%d.pth \
--dropout 0.4
