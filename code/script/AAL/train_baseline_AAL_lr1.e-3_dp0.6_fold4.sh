...
--train_info_path ../model/train_AAL_lr1.e-3_dp0.6_fold4_info.csv \
--valid_info_path ../model/valid_AAL_lr1.e-3_dp0.6_fold4_info.csv \
--model_path ../model/baseline/baseline_AAL_lr1.e-3_dp0.6_fold4_epoch%d.pth \
--dropout 0.6 --save_start_epoch 100 --kth_fold 4
